package br.com.mariojp.condominio.start;
...
public class Start {
	...
	private static File getRootFolder() {
		...
		try {
			File root;
			String runningJarPath = Start.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath()
					.replaceAll("\\\\", "/");
	...
	public static void main(String[] args) throws Exception {
		...
		// File configFile = new File(root.getAbsolutePath(),
